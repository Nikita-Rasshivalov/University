...
public class AdminService extends BaseService {
    ...
    public void AddCar() {
        ...
        switch (value) {
            case 1:
                _carRepository.CreateXml(new TankTruck(stamp, number, isBroken));
                break;
            case 2:
                _carRepository.CreateXml(new Refrigerator(stamp, number, isBroken));
                break;
            case 3:
                _carRepository.CreateXml(new ContainerShip(stamp, number, isBroken));
                break;
            default:
                return;
        }
