...
namespace Server
{
    public class HttpServer
    {
        ...
        private string GetResponseMessage(string messageData)
        {
            ...
            else if (httpPath.Equals("/sort/insertSort.txt", StringComparison.InvariantCultureIgnoreCase))
            {
                return httpMethod switch
                {
                    "GET" => GetInsertSortPage(),
                    "POST" => GetInsertSortResponsePage(requestBody),
                    _ => GetNotFoundPage(),
                };
            }
        ...
        private string GetInsertSortPage()
        {
            StringBuilder bodyBuilder = new StringBuilder();
        ...
        private string GetInsertSortResponsePage(string body)
        {
            int[] array;
